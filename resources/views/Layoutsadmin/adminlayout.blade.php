    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="list {{ Request::segment(2) == 'profil' ? 'active' : '' }}">
                ...
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="/admin/profile/profil">Profile</a></li>
                </ul>
            </li>
            {{-- <li class="list {{ Request::segment(2) == 'view' ? 'active' : '' }}">
                <a href="/user/view">
                    <i class="bi bi-people-fill"></i>
                    <span class="link_name">Data User</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="/user/view">Data User</a></li>
                </ul>
            </li> --}}
