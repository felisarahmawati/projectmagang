        ...
        <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-12">
                                <label for="inputKendaraan" class="form-label"><b>Paket</b></label>
                                <select id="inputKendaraan" class="form-select">
                                    <option selected>Pilih Paket</option>
                                    <option>Kamar Kos</option>
                                    <option>Rumah</option>
                            ...
                            <div class="col-sm-4">
                                <label for="Quantity"><b>Catatan</b></label>
                            ...
                            <div class="d-grid gap-2 col-6 mx-auto" style="width:35%">
                                <a class="btn btn-outline-success" href="/user/pemesanan/Pemesanan/paket" role="button">Order</a>
                            </div>
                        </div>
                    </div>
                </div>
